...
**How to apply:** Keep the mobile form behavior aligned with Web: normalize invitation codes, validate through the existing invitation endpoint, show validation errors, and keep acceptance disabled until a valid invitation is loaded. For invalid organization/invitation codes, show only “Invalid invitation code. Please check and try again.” rather than status codes or raw payloads.